...
Public Function GetConnectionData() As String()
    ...
    Data(0) = IIf(lSpeed <> 0, CStr(lSpeed) & " bps", "Request error.")
    Data(1) = RasGetConnectedEntry
    Data(2) = 0
    ...
    Data(3) = LocalIP: lblHost = RemoteIP
    Data(4) = GetHostByIP(RemoteIP)

End Function

Function MakeIP(ByVal lData As Long) As String
...
Function GetHostByIP(ByVal strIP As String) As String
    ...
    If apiError = 0 Then Exit Function
...
Function Byte2String(bString() As Byte) As String
Dim i As Integer
    While bString(i) <> 0&
