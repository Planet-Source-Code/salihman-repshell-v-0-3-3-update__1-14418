...
Public Function SHNotify_Unregister() As Boolean
    ...
    If lSHNotify Then
        ...
        If SHChangeNotifyDeregister(lSHNotify) Then
            lSHNotify = 0
...
Public Sub NotificationReceipt(wParam As Long, lParam As Long)
    ...
    Select Case lParam
      Case SHCNE_UPDATEIMAGE
        ...
        If iImage = 31 Or iImage = 32 Then
          frmMain.ImgIcon(1).Tag = ProperPath(App.Path) & "Icons\Recycle" & _
                    IIf(iImage = 31, "Full", "Empty") & ".ico"
